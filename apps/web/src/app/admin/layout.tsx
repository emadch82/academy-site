...
const sidebarLinks = [
  ...
  { icon: FiAward, label: 'آزمون‌ها', href: '/admin/quiz' },
  { icon: FiFileText, label: 'جزوات دوره‌ها', href: '/admin/materials' },
  { icon: FiClock, label: 'برنامه کلاسی', href: '/admin/schedule' },
  { icon: FiUserCheck, label: 'درخواست‌های غیبت', href: '/admin/leave-requests' },
  { icon: FiCalendar, label: 'رزرو مشاوره', href: '/admin/appointments' },
